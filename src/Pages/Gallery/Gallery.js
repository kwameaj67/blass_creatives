...
import gall2 from '../../assets/ayo-ogunseinde-1L5QpkSs5IU-unsplash.webp'
...
import gall8 from '../../assets/alex-sorto--fowxtAtWW8-unsplash.webp'
...
const Gallery = () => {
    ...
    const animation = ()=> {
        ...
        const gall5 = imagesSection2.firstElementChild
        const gall9= imagesSection2.lastElementChild
        const gall8 = imagesSection3.firstElementChild
        const gall7= imagesSection3.lastElementChild
        const gall1 = imagesSection4.firstElementChild
        const gall4= imagesSection4.lastElementChild

        TweenMax.to(app,0,{css:{visibility:'visible'}})
        tl.from(gall2, 1.2 , {y:1280, ease:Power3.easeOut})  // 2,3 
        ...
        tl.from(gall5, 1.2 , {y:1280, ease:Power3.easeOut})  // 5,9
        .from(gall5.firstElementChild, 2, { scale:1.6, ease:Power3.easeInOut}, .2)
        .from(gall9, 1.2 , {y:1280, ease:Power3.easeOut}, .2)
        .from(gall9.firstElementChild, 2, { scale:1.6, ease:Power3.easeInOut}, .2)
        // console.log(gall2,gall3)

        tl.from(gall8, 1.2 , {y:1280, ease:Power3.easeOut})  // 8,7
        .from(gall8.firstElementChild, 2, { scale:1.6, ease:Power3.easeInOut}, .2)
        .from(gall7, 1.2 , {y:1280, ease:Power3.easeOut}, .2)
        .from(gall7.firstElementChild, 2, { scale:1.6, ease:Power3.easeInOut}, .2)

        tl.from(gall1, 1.2 , {y:1280, ease:Power3.easeOut})  // 1,4
        .from(gall1.firstElementChild, 2, { scale:1.6, ease:Power3.easeInOut}, .2)
        .from(gall4, 1.2 , {y:1280, ease:Power3.easeOut}, .2)
        .from(gall4.firstElementChild, 2, { scale:1.6, ease:Power3.easeInOut}, .2)
    }
    useEffect(() => {
    ...
    return (
        <div className="gallery-page" ref={el => app = el}>
            ...
            <div className="gallery-image-container" >
                ...
                <div className="gallery-img " ref={el => imagesSection4 = el} >
